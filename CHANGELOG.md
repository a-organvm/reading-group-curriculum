...
### Added
- `data_export` module — generates `data/curricula-index.json` and `data/sample-curriculum.md` from seed data
- `curriculum-data-export` CLI entry point
- 6 new tests in `tests/test_data_export.py`
